...
### bin/kafka-topics.sh --create --bootstrap-server SSL://localhost:9093 --replication-factor 1 --partitions 1 --topic test
bin/kafka-topics.sh --list --bootstrap-server "SSL://localhost:9093" --command-config ./config/ssl-user-config.properties
